  ...
  return (
    <div className="w-5/6  mx-auto mt-8 ">
      ...
      <p className="text-gray-600 my-4">
        ...
        That&aspos;s why our collection features everything from
        high-performance running shoes to versatile walking sneakers. Whether
        you’re gearing up for a marathon, enjoying a casual stroll, or simply
        seeking everyday comfort, our range includes something for every
        occasion and preference. Our assortment of men’s shoes combines rugged
        durability with modern design, while our women’s collection offers both
        elegance and practicality. For the little ones, we have a variety of fun
